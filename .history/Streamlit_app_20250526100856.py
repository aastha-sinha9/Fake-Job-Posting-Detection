...
def download_glove():
    if not os.path.exists("glove.6B.100d.txt"):
        ...
        # Add code to unzip it


# Google Drive links (make sure they are direct file links from Google Drive Direct Link Generator)
MODEL_URL = "https://drive.google.com/uc?export=download&id=18gMtzQ-lwn-BO580P9qjf27b1PPC7oFN"
TOKENIZER_URL = "https://drive.google.com/uc?id=1RWIrXYjkOFh_ln6dxS6pi366B0v6cbzg"
