...
model = tf.keras.models.load_model("C:\Users\aasth\Desktop\ML Projects\Fake Job Posting Detection\Model\ann_model.h5")
with open("tokenizer.pkl", "rb") as f:
    tokenizer = pickle.load(f)

# Constants
MAX_LEN = 200  # should match what you used during training
